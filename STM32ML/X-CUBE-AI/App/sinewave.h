...
#define AI_SINEWAVE_ORIGIN_MODEL_NAME   "model"
...
#define AI_SINEWAVE_IN_1_SIZE_BYTES  (AI_SINEWAVE_IN_1_SIZE * 1)
...
#define AI_SINEWAVE_OUT_1_SIZE_BYTES  (AI_SINEWAVE_OUT_1_SIZE * 1)

/******************************************************************************/
#define AI_SINEWAVE_N_NODES (3)
